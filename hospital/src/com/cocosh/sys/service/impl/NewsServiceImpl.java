...
public class NewsServiceImpl implements NewsService {
	...
	@Override
	public List<News> queryBanners() {
		return mapper.queryBanners();
	}

	@Override
	public List<News> queryNews(Integer pageNo) {
		return mapper.queryNews((pageNo-1)*5);
	}

	@Override
	public List<News> queryActivity(Integer pageNo) {
		return mapper.queryActivity((pageNo-1)*10);
	}

	@Override
	public News queryStartAdvert() {
		return mapper.queryStartAdvert();
	}

	@Override
	public AjaxResult addStartAdvert(News po) {
		News news=mapper.queryStartAdvert();
		if (news!=null) {
