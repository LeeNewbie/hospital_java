...
//		System.out.println(url+"?"+dataStr);
	...
	public static JSONObject chargePost(String url,String token,String paramJson){
		...
		try {
			...
			String dataStr=AESUtil.Encrypt(paramJson,CommonUtil.StartAESSpec);
			String timestamp=DateUtil.formatDate(new Date(),"yyyyMMddHHmmss");
			String sigStr=HMacMD5.getHmacMd5Str(CommonUtil.cKey,CommonUtil.OperatorID+dataStr+timestamp+"0001");
			//设置body数据
