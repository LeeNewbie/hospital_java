...
public class AESUtil {
    ...
    public static String Encrypt(String sSrc, String sKey,String ivStr){
        try {
			...
			str=str.replaceAll("\r\n", "").replaceAll("\r", "").replaceAll("\n", "").replaceAll("/r/n", "").replaceAll("/r", "").replaceAll("/n", "");
//			str=str.replaceAll("\r\n", "");
 ...
 * */
    public static void main(String[] args) throws Exception {
         ...
         */
        String cKey = "BX4S6MrqDzChs1av";
        // 需要加密的字串
        JSONObject o=new JSONObject();
		o.put("OperatorID","MA1K370P7");
		o.put("OperatorSecret","Kv1xYAA3m1w1JQ4G");
...
//        String DeString = AESUtil.Decrypt("a5myUQdC89nUerJchc+EDrlm9T59qN7fweOKVak4X4L5tgzmfCNXSIkZm8soVqXa6a2UUDRrrQ0ilZ4gDxX93LC9lwL/nQB+Aj7/gQFoVxFDWs+SmUquhXv9yyzGegtfv2q+LrgyBduXJp7hRFQiUtmycps3ieIhSW3iM7MT1tCGEJtaqAdJxI2ePoETOxKTC7eOUXUsN4lKrimw6zqU1PucoqjNzYa8W8l9DxWJr5I=", cKey);
//        String DeString = AESUtil.Decrypt("j9ncB/691aGjAgVMUEfv0nFU9vVoI+V9xAREGANCHCaVMUH3CscqzhFnY5vm5eUyFrVQfLy31XKqJT6NYqk9Ag==", cKey);
        String DeString = AESUtil.Decrypt("", cKey);
