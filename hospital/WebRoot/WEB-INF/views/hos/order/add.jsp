                        ...
                        <form action="" method="post" class="form-horizontal">
                         <div class="gray-bg" id="order_div" style="padding: 20px 0px;margin-bottom: 20px">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                  <label class="checkbox-inline i-checks"><input type="checkbox" value="病窦" name="diagnose">病窦</label>
                                  <label class="checkbox-inline i-checks"><input type="checkbox" value="房颤伴长RR间期" name="diagnose">房颤伴长RR间期</label>
                                  <label class="checkbox-inline i-checks"><input type="checkbox" value="扩张型心肌病" name="diagnose">扩张型心肌病</label>
                                  <label class="checkbox-inline i-checks"><input type="checkbox" value="晕厥" name="diagnose">晕厥</label>
                                  <label class="checkbox-inline i-checks"><input type="checkbox" value="肥厚新型心肌病" name="diagnose">肥厚新型心肌病</label>
                                  <label class="checkbox-inline i-checks"><input type="checkbox" value="缺血型心肌病" name="diagnose">缺血型心肌病</label>
                                  <label class="checkbox-inline i-checks"><input type="checkbox" value="心脏骤停" name="diagnose">心脏骤停</label>
                                  <label class="checkbox-inline i-checks"><input type="checkbox" value="遗传性心律失常" name="diagnose">遗传性心律失常</label>
                                  <label class="checkbox-inline i-checks"><input type="checkbox" value="房室传导阻滞" name="diagnose">房室传导阻滞</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">其他</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="diagnose_other">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label">植入时间</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" name="plant_date">
                                </div>
                                <label class="col-sm-1 control-label">手术耗时</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" name="operation_time">
                                </div>
                           ...
                           <div class="form-group">
                             <label class="col-sm-1 control-label">手术类型</label>
                                ...
                                <div class="col-sm-2">
                                	是&nbsp;<input type="checkbox" class="js-switch" name="is_change"/>&nbsp;否
                                </div>
                                 <label class="col-sm-1 control-label">自身心率</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" name="hreat_rate">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                          ...
                          <div class="form-group">
                             <label class="col-sm-1 control-label">A组</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" name="agroup">
                                </div>
                                 <label class="col-sm-1 control-label">导管室</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" name="daoroom">
                                </div>
                                 <label class="col-sm-1 control-label">三维</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" name="sanwei">
                                </div>
                                 <label class="col-sm-1 control-label">多导</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" name="duodao">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                             <div class="form-group">
                         ...
                         <div class="gray-bg" id="product_div" style="padding: 20px 0px;margin-bottom: 20px">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                                                                                              有&nbsp;<input type="checkbox" class="js-switch" name="compatible"/>&nbsp;无            
                                </div>
                             ...
                             <div class="table-responsive m-t well" style="margin-left: 5%;width: 50%" >
				                        <table class="table invoice-table">
				                            ...
				                            <tbody>
				                               <tr>
				                                 <td>心房</td>
				                                 <td><input type="text" name="hreart_type"></td>
				                                 <td><input type="text" name="hreat_sn"></td>
				                                 <td>
				                               ...
				                               <tr>
				                                 <td>右心室</td>
				                                 <td><input type="text" name="right_type"></td>
				                                 <td><input type="text" name="right_sn"></td>
				                                 <td>
				                               ...
				                               <tr>
				                                 <td>左室</td>
				                                 <td><input type="text" name="left_type"></td>
				                                 <td><input type="text" name="left_sn"></td>
				                                 <td>
                             ...
                             <div class="table-responsive m-t well" style="margin-left: 5%;" >
				                        <table class="table invoice-table">
				                            ...
				                            <tbody>
				                               <tr>
				                                 <td>心房</td>
				                                 <td><input type="text" name="hreat_yuzhi">v</td>
				                                 <td><input type="text" name="hreat_width">ms</td>
				                                 <td><input type="text" name="hreat_feel">mv</td>
				                                 <td><input type="text" name="hreat_forbid"></td>
				                                 <td>有&nbsp;<input type="checkbox" class="js-switch" name="hreat_isfeel"/>&nbsp;否</td>
				                               	 <td><input type="text" name="hreat_active"></td>
				                               </tr>
				                                <tr>
				                                 <td>右室</td>
				                                 <td><input type="text" name="right_yuzhi">v</td>
				                                 <td><input type="text" name="right_width">ms</td>
				                                 <td><input type="text" name="right_feel">mv</td>
				                                 <td><input type="text" name="right_forbid"></td>
				                                 <td>有&nbsp;<input type="checkbox" class="js-switch" name="right_isfeel"/>&nbsp;否</td>
				                               	 <td><input type="text" name="right_active"></td>
				                               	 <td><input type="text" name="right_high"></td>
				                               </tr>
				                                <tr>
				                                 <td>左室</td>
				                                 <td><input type="text" name="left_yuzhi">v</td>
				                                 <td><input type="text" name="left_width">ms</td>
				                                 <td><input type="text" name="left_feel">mv</td>
				                                 <td><input type="text" name="left_forbid"></td>
				                                 <td>有&nbsp;<input type="checkbox" class="js-switch" name="left_isfeel"/>&nbsp;否</td>
				                               	 <td><input type="text" name="left_active"></td>
				                               </tr>
				                            </tbody>
				                        </table>
				                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2" >
                                   <span onclick="change_lbbb()">
                                                                                                           是&nbsp;<input type="checkbox" class="js-switch"  name="lbbb"/>&nbsp;否                 
                                   </span>
                                </div>
                             </div>
                         <div id="lbbb_div">
                            <div class="hr-line-dashed"></div>
                             ...
                             <div class="form-group">
                               <label class="col-sm-2 control-label">术前QRS宽度（ms）</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" name="qrs_width">
                                </div>
                             </div>
	                                   ...
	                                   <div class="table-responsive m-t well" style="margin-left: 5%;" >
					                        <table class="table invoice-table">
					                            ...
					                            <tbody>
					                               ...
					                               <tr>
					                                 <td>损伤电流是否</td>
					                                 <td>是&nbsp;<input type="checkbox" class="js-switch" name="is_damage"/>&nbsp;否</td>
					                               </tr>
					                            </tbody>
					                        </table>
					                        </div>
   ...
   <script src="${ctx}/statics/manage/js/plugins/datapicker/bootstrap-datepicker.js"></script>
    ...
    <script>
        ...
        function add(){
        	...
        	var ordertest={"hreat_yuzhi":$("[name='hreat_yuzhi']").val(),"hreat_width":$("[name='hreat_width']").val(),"hreat_feel":$("[name='hreat_feel']").val(),"hreat_forbid":$("[name='hreat_forbid']").val(),"hreat_isfeel":hreat_isfeel,"hreat_active":$("[name='hreat_active']").val(),
        	...
        	var params={"sn":$("[name='sn']").val(),"name":$("[name='name']").val(),"mobile":$("[name='mobile']").val(),"gender":$("[name='gender']").val(),"age":$("[name='age']").val(),
