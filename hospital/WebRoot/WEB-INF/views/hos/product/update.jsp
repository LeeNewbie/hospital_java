...
<body>
                    ...
                    <div class="ibox-content">
                        <form action="" method="post" class="form-horizontal">
                          <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="name" value="${product.name }" required data-bv-notempty-message="厂家不能为空">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="number" value="${product.number }" required data-bv-notempty-message="型号不能为空">
                                </div>
                            </div>
                            <div class="form-group">
    ...
    $(document).ready(function() {
        ...
        function update(){
        	...
        	$.post("${ctx}/manage/product/update",{"id":"${product.id}","name":$("[name='name']").val(),"number":$("[name='number']").val()},function(data){
        		if(data.code=="0"){
					opt_success("修改成功",0);
				}else if(data.code=="2"){
					opt_error("型号重复");
