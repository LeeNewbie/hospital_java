...
<body>
                ...
                <div class="ibox float-e-margins">
                     ...
                     <div class="gray-bg" id="order_div" style="padding: 20px 0px;margin-bottom: 20px">
                        <h2>随访产信息</h2>
                         <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control"  name="visit_date" value="<fmt:formatDate value='${item.visit_date }' pattern='yyyy-MM-dd'/>">
                                </div>
                                <label class="col-sm-2 control-label">下次随访日期</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control"  name="next_date" value="<fmt:formatDate value='${item.next_date }' pattern='yyyy-MM-dd'/>">
                                </div>
                            </div>
                             <div class="form-group">
				                        ...
				                        <table class="table invoice-table">
				                            <tbody>
				                              <tr>
				                               ...
				                               <tr>
				                                 <td><input type="text" name="first_date"  value="<fmt:formatDate value='${item.first_date }' pattern='yyyy-MM-dd'/>"></td>
				                                 <td><input type="text" name="three_date"  value="<fmt:formatDate value='${item.three_date }' pattern='yyyy-MM-dd'/>"></td>
				                                 <td><input type="text" name="six_date"  value="<fmt:formatDate value='${item.six_date }' pattern='yyyy-MM-dd'/>"></td>
				                                 <td><input type="text" name="year_date"  value="<fmt:formatDate value='${item.six_date }' pattern='yyyy-MM-dd'/>"></td>
				                               </tr>
				                            </tbody>
				                        </table>
				        </div>
                      ...
                      <div class="gray-bg" id="item_div" style="padding: 20px 0px;margin-bottom: 20px">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control"  name="situation" value="${item.situation}">
                                </div>
                                <div class="col-sm-2">
                                    <input class="fileInput" id="situation_img" type="file" name="file" multiple="multiple" accept="image/*"/>
                                </div>
                                 <div class="col-sm-6 imagesdiv">
                                     <c:if test="${not empty item.situation_img}">
	                                       <c:forEach items="${fn:split(item.situation_img, ',')}" var="img_url">
	                                           <img src="${img_url}" onclick="$(this).remove()">
								           </c:forEach>
								    </c:if> 
                                 </div>
                        </div>
                        <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                                                                                      是&nbsp;<input type="checkbox" class="js-switch" name="hreat_chao" <c:if test="${item.hreat_chao==1}">checked</c:if>/>&nbsp;否 
                                </div>
                                <div class="col-sm-2">
                                    <input class="fileInput" id="hreat_img" type="file" name="file" multiple="multiple" accept="image/*"/>
                                </div>
                                 <div class="col-sm-6 imagesdiv">
                                   <c:if test="${not empty item.hreat_img}">
	                                       <c:forEach items="${fn:split(item.hreat_img, ',')}" var="img_url">
	                                           <img src="${img_url}" onclick="$(this).remove()">
								           </c:forEach>
								    </c:if> 
                                 </div>
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                                                                                      是&nbsp;<input type="checkbox" class="js-switch" name="rabat" <c:if test="${item.rabat==1}">checked</c:if>/>&nbsp;否 
                                </div>
                                <div class="col-sm-2">
                                    <input class="fileInput" id="rabat_img" type="file" name="file" multiple="multiple" accept="image/*"/>
                                </div>
                                 <div class="col-sm-6 imagesdiv">
                                      <c:if test="${not empty item.rabat_img}">
	                                       <c:forEach items="${fn:split(item.rabat_img, ',')}" var="img_url">
	                                           <img src="${img_url}" onclick="$(this).remove()">
								           </c:forEach>
								     </c:if> 
                                 </div>
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                                                                                      是&nbsp;<input type="checkbox" class="js-switch" name="elect" <c:if test="${item.elect==1}">checked</c:if>/>&nbsp;否 
                                </div>
                                <div class="col-sm-2">
                                    <input class="fileInput" id="elect_img" type="file" name="file" multiple="multiple" accept="image/*"/>
                                </div>
                                 <div class="col-sm-6 imagesdiv">
                                     <c:if test="${not empty item.elect_img}">
	                                       <c:forEach items="${fn:split(item.elect_img, ',')}" var="img_url">
	                                           <img src="${img_url}" onclick="$(this).remove()">
								           </c:forEach>
								     </c:if> 
                                 </div>
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                                                                                      是&nbsp;<input type="checkbox" class="js-switch" name="blood" <c:if test="${item.blood==1}">checked</c:if>/>&nbsp;否 
                                </div>
                                <div class="col-sm-2">
                                    <input class="fileInput" id="blood_img" type="file" name="file" multiple="multiple" accept="image/*"/>
                                </div>
                                 <div class="col-sm-6 imagesdiv">
                                    <c:if test="${not empty item.blood_img}">
	                                       <c:forEach items="${fn:split(item.blood_img, ',')}" var="img_url">
	                                           <img src="${img_url}" onclick="$(this).remove()">
								           </c:forEach>
								     </c:if> 
                                 </div>
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                                                                                      是&nbsp;<input type="checkbox" class="js-switch" name="have_other" <c:if test="${item.have_other==1}">checked</c:if>/>&nbsp;否 
                                </div>
                                 <div class="col-sm-2">
                                    <input type="text" class="form-control"  name="other" value="${item.other}">
                                </div>
                                <div class="col-sm-2">
                                    <input class="fileInput" id="other_img" type="file" name="file" multiple="multiple" accept="image/*"/>
                                </div>
                                 <div class="col-sm-4 imagesdiv">
                                    <c:if test="${not empty item.other_img}">
	                                       <c:forEach items="${fn:split(item.other_img, ',')}" var="img_url">
	                                           <img src="${img_url}" onclick="$(this).remove()">
								           </c:forEach>
								     </c:if>
                                 </div>
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                                                                                      是&nbsp;<input type="checkbox" class="js-switch" name="magnet" <c:if test="${item.magnet==1}">checked</c:if>/>&nbsp;否 
                                </div>
                                <div class="col-sm-2">
                                    <input class="fileInput" id="magnet_img" type="file" name="file" multiple="multiple" accept="image/*"/>
                                </div>
                                 <div class="col-sm-6 imagesdiv">
                                    <c:if test="${not empty item.magnet_img}">
	                                       <c:forEach items="${fn:split(item.magnet_img, ',')}" var="img_url">
	                                           <img src="${img_url}" onclick="$(this).remove()">
								           </c:forEach>
								     </c:if>
                                 </div>
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control"  name="check_location" value="${item.check_location }">
                                </div>
                                <div class="col-sm-2">
                        ...
                        <div class="table-responsive m-t well" style="margin-left: 5%;width: 60%;border: none" >
				                        <table class="table invoice-table">
				                            ...
				                            <tbody>
				                               <tr>
				                                 <td>MRI模式</td>
				                                 <td><input type="text" name="mri_mode" value="${item.mri_mode }"></td>
				                                 <td>MRI脉冲振幅</td>
				                                 <td><input type="text"  name="mri_house" value="${item.mri_house }">v</td>
				                                 <td><input type="text"  name="mri_room" value="${item.mri_room}">v</td>
				                               </tr>
				                                <tr>
				                                 <td>MRI基本频率</td>
				                                 <td><input type="text"  name="mri_rate" value="${item.mri_rate }"></td>
				                                 <td>MRI脉宽</td>
				                                 <td><input type="text"  name="mri_width_house" value="${item.mri_width_house }">ms</td>
				                                 <td><input type="text"  name="mri_width_room" value="${item.mri_width_room}">ms</td>
				                               </tr>
				                               <tr>
				                                 <td>MRI起搏的AV期间</td>
				                                 <td><input type="text"  name="mri_period" value="${item.mri_period }"></td>
				                                 <td>MRI脉冲装置</td>
				                                 <td><input type="text"  name="mri_set_house" value="${item.mri_set_house }"></td>
				                                 <td><input type="text"  name="mri_set_room" value="${item.mri_set_room }"></td>
				                               </tr>
				                            </tbody>
				                        </table>
				        </div>
				         <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                                                                                      是&nbsp;<input type="checkbox" class="js-switch" name="is_moresix" <c:if test="${item.is_moresix==1}">checked</c:if>/>&nbsp;否 
                                </div>
                        </div>
                         <div class="form-group">
                                <label class="col-sm-2 control-label">无其他心脏硬件（适配器，扩展器，废弃电极导线）</label>
                                <div class="col-sm-2">
                                                                                                      是&nbsp;<input type="checkbox" class="js-switch" name="is_hard" <c:if test="${item.is_hard==1}">checked</c:if>/>&nbsp;否 
                                </div>
                        </div>
                        <div class="form-group">
                                <label class="col-sm-2 control-label">磁共振检查中心电监测</label>
                                <div class="col-sm-2">
                                                                                                      是&nbsp;<input type="checkbox" class="js-switch" name="is_check" <c:if test="${item.is_check==1}">checked</c:if>/>&nbsp;否 
                                </div>
                        </div>
                         <div class="form-group">
                                <label class="col-sm-2 control-label">SAR值</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control"  name="sar" value="${item.sar }">
                                </div>
                         </div>
                        <div class="table-responsive m-t well" style="margin-left: 5%;width: 60%;border: none" >
				                        <table class="table invoice-table">
				                            ...
				                            <tbody>
				                               <tr>
				                                 <td></td>
				                                 <td>心房</td>
				                                 <td><input type="text"  name="before_house_yuzhi" value="${item.before_house_yuzhi}">v</td>
				                                 <td><input type="text"  name="before_house_feel" value="${item.before_house_feel }">mv</td>
				                                 <td><input type="text"  name="before_house_forbid" value="${item.before_house_forbid }">Ω</td>
				                               </tr>
				                               <tr>
				                                 <td></td>
				                                 <td>心室</td>
				                                 <td><input type="text"  name="before_room_yuzhi" value="${item.before_room_yuzhi }">v</td>
				                                 <td><input type="text"  name="before_room_feel" value="${item.before_room_feel }">mv</td>
				                                 <td><input type="text"  name="before_room_forbid" value="${item.before_room_forbid }">Ω</td>
				                               </tr>
				                                <tr><th colspan="2">磁共振检查后</th>
				                                 ...
				                                 <td></td>
				                                 <td>心房</td>
				                                 <td><input type="text"  name="after_house_yuzhi" value="${item.after_house_yuzhi }">v</td>
				                                 <td><input type="text"  name="after_house_feel" value="${item.after_house_feel }">mv</td>
				                                 <td><input type="text" name="after_house_forbid" value="${item.after_house_forbid }">Ω</td>
				                               </tr>
				                               <tr>
				                                 <td></td>
				                                 <td>心室</td>
				                                 <td><input type="text"  name="after_room_yuzhi" value="${item.after_room_yuzhi }">v</td>
				                                 <td><input type="text"  name="after_room_feel" value="${item.after_room_feel }">mv</td>
				                                 <td><input type="text" name="after_room_forbid" value="${item.after_room_forbid }">Ω</td>
				                               </tr>
				                            </tbody>
				                        </table>
				         </div>
                      ...
                      <div class="gray-bg" id="brady_div" style="padding: 20px 0px;margin-bottom: 20px">
                        <h2>Brady设置</h2>
                         <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <input type="text" class="form-control"  name="work_mode" value="${brady.work_mode }">
                                </div>
                                <label class="col-sm-1 control-label">基本频率（bpm）</label>
                                <div class="col-sm-1">
                                    <input type="text" class="form-control"  name="basic_rate" value="${brady.basic_rate }">
                                </div>
                                <label class="col-sm-1">上线频率（bpm）</label>
                                <div class="col-sm-1">
                                    <input type="text" class="form-control"  name="up_rate" value="${brady.up_rate }">
                                </div>
                                <label class="col-sm-1 control-label">休息/睡眠频率（bpm）</label>
                                <div class="col-sm-1">
                                    <input type="text" class="form-control"  name="rest_rate" value="${brady.rest_rate }">
                                </div>
                                <label class="col-sm-1 control-label">滞后频率（bpm）</label>
                                <div class="col-sm-1">
                                    <input type="text" class="form-control"  name="late_rate" value="${brady.late_rate }">
                                </div>
                         </div>
                         <div class="form-group">
                                <label class="col-sm-2 control-label">起搏的AV</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control"  name="qibo_av" value="${brady.qibo_av }">
                                </div>
                                <label class="col-sm-1 control-label">感知的AV</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control"  name="feel_av" value="${brady.feel_av }">
                                </div>
                                <label class="col-sm-1">A-V期间管理</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control"  name="av_period" value="${brady.av_period }">
                                </div>
                         </div>
				                        ...
				                        <table class="table invoice-table">
				                            ...
				                            <tbody>
				                               <tr>
				                                 <td></td>
				                                 <td>心房</td>
				                                 <td><input type="text"  name="hreat_out" value="${brady.hreat_out }"></td>
				                                 <td><input type="text"  name="hreat_width" value="${brady.hreat_width }"></td>
				                                 <td>是&nbsp;<input type="checkbox" class="js-switch" name="hreat_yuzhi" <c:if test="${brady.hreat_yuzhi==1 }">checked</c:if>/>&nbsp;否 </td>
				                                 <td><input type="text"  name="hreat_sensive" value="${brady.hreat_sensive }"></td>
				                                 <td>是&nbsp;<input type="checkbox" class="js-switch" name="hreat_feel" <c:if test="${brady.hreat_forbid==1 }">checked</c:if>/>&nbsp;否 </td>
				                                 <td>是&nbsp;<input type="checkbox" class="js-switch" name="hreat_forbid" <c:if test="${brady.hreat_forbid==1 }">checked</c:if>/>&nbsp;否 </td>
				                               </tr>
				                                <tr>
				                                 <td></td>
				                                 <td>心房</td>
				                                 <td><input type="text"  name="right_out" value="${brady.right_out }"></td>
				                                 <td><input type="text"  name="right_width" value="${brady.right_width }"></td>
				                                 <td>是&nbsp;<input type="checkbox" class="js-switch" name="right_yuzhi" <c:if test="${brady.right_yuzhi==1 }">checked</c:if>/>&nbsp;否 </td>
				                                 <td><input type="text"  name="right_sensive" value="${brady.right_sensive }"></td>
				                                 <td>是&nbsp;<input type="checkbox" class="js-switch" name="right_feel" <c:if test="${brady.right_feel==1 }">checked</c:if>/>&nbsp;否 </td>
				                                 <td>是&nbsp;<input type="checkbox" class="js-switch" name="right_forbid" <c:if test="${brady.right_forbid==1 }">checked</c:if>/>&nbsp;否 </td>
				                               </tr>
				                                <tr>
				                                 <td></td>
				                                 <td>心房</td>
				                                 <td><input type="text" name="left_out" value="${brady.left_out }"></td>
				                                 <td><input type="text"  name="left_width" value="${brady.left_width }"></td>
				                                 <td>是&nbsp;<input type="checkbox" class="js-switch" name="left_yuzhi" <c:if test="${brady.left_yuzhi==1 }">checked</c:if>/>&nbsp;否 </td>
				                                 <td><input type="text"  name="left_sensive" value="${brady.left_sensive }"></td>
				                                 <td>是&nbsp;<input type="checkbox" class="js-switch" name="left_feel" <c:if test="${brady.left_feel==1 }">checked</c:if>/>&nbsp;否 </td>
				                                 <td>是&nbsp;<input type="checkbox" class="js-switch" name="left_forbid" <c:if test="${brady.left_forbid==1 }">checked</c:if>/>&nbsp;否 </td>
				                               </tr>
				                            </tbody>
				                        </table>
				         </div>
                        ...
                        <div class="table-responsive m-t well" style="margin-left: 5%;border: none" >
				                        <table class="table invoice-table">
				                            ...
				                            <tbody>
				                               <tr>
				                                 <td>VT-1</td>
				                                 <td><input type="text"  name="vt1_name" value="${icd.vt1_name }"></td>
				                                 <td>是&nbsp;<input type="checkbox" class="js-switch" name="vt1_ison" <c:if test="${icd.vt1_ison==1 }">checked</c:if>/>&nbsp;否</td>
				                                 <td><input type="text" name="vt1_rate" value="${icd.vt1_rate }"></td>
				                                 <td><input type="text"  name="vt1_period"  value="${icd.vt1_period }"></td>
				                                 <td><input type="text"  name="vt1_identify"  value="${icd.vt1_identify }"></td>
				                                 <td><input type="text"  name="vt1_scheme"  value="${icd.vt1_scheme }"></td>
				                               </tr>
				                                <tr>
				                                <td>VT-2</td>
				                                 <td><input type="text"  name="vt2_name" value="${icd.vt2_name }"></td>
				                                 <td>是&nbsp;<input type="checkbox" class="js-switch" name="vt2_ison" <c:if test="${icd.vt2_ison==1 }">checked</c:if>/>&nbsp;否</td>
				                                 <td><input type="text"  name="vt2_rate" value="${icd.vt2_rate }"></td>
				                                 <td><input type="text"  name="vt2_period" value="${icd.vt2_period }"></td>
				                                 <td><input type="text"  name="vt2_identify" value="${icd.vt2_identify }"></td>
				                                 <td><input type="text"  name="vt2_scheme" value="${icd.vt2_scheme }"></td>
				                               </tr>
				                                <tr>
				                                <td>VF</td>
				                                 <td><input type="text"  name="vf_name" value="${icd.vf_name }"></td>
				                                 <td>是&nbsp;<input type="checkbox" class="js-switch" name="vf_ison" <c:if test="${icd.vf_ison==1 }">checked</c:if>/>&nbsp;否</td>
				                                 <td><input type="text" name="vf_rate" value="${icd.vf_rate }"></td>
				                                 <td><input type="text"  name="vf_period" value="${icd.vf_period }"></td>
				                                 <td><input type="text" name="vf_identify" value="${icd.vf_identify }"></td>
				                                 <td><input type="text" name="vf_scheme" value="${icd.vf_scheme }"></td>
				                               </tr>
				                            </tbody>
				                        </table>
				         </div>
                      ...
                      <div class="gray-bg" id="crt_div" style="padding: 20px 0px;margin-bottom: 20px">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                                                                                       是&nbsp;<input type="checkbox" class="js-switch" name="crt_ischange" <c:if test="${icd.crt_ischange==1 }">checked</c:if>/>&nbsp;否
                                </div>
                                <label class="col-sm-1 control-label">左室向量</label>
                                <div class="col-sm-1">
                                    <input type="text" class="form-control"  name="crt_left" value="${icd.crt_left }">
                                </div>
                                 <label class="col-sm-1 control-label">SAV/PAV</label>
                                <div class="col-sm-1">
                                    <input type="text" class="form-control"  name="crt_sav" value="${icd.crt_sav }">
                                </div>
                                 <label class="col-sm-1 control-label">VV期间</label>
                                <div class="col-sm-1">
                                    <input type="text" class="form-control"  name="crt_period" value="${icd.crt_period }">
                                </div>
                                <label class="col-sm-1 control-label">QRS宽度</label>
                                <div class="col-sm-1">
                                    <input type="text" class="form-control"  name="crt_width" value="${icd.crt_width }">
                                </div>
                         </div>
                     </div>
                      ...
                      <div class="gray-bg" id="diagnose_div" style="padding: 20px 0px;margin-bottom: 20px">
                        ...
                        <div class="table-responsive m-t well" style="margin-left: 5%;border: none" >
				                        <table class="table invoice-table">
				                            ...
				                            <tbody>
				                               <tr>
				                                 <td><input type="text"  name="ap" value="${diagnose.ap}"></td>
				                                 <td><input type="text"  name="vp" value="${diagnose.vp }"></td>
				                                 <td><input type="text"  name="bp" value="${diagnose.bp }"></td>
				                                 <td><input type="text"  name="asvp" value="${diagnose.asvp }"></td>
				                                 <td><input type="text"  name="asvs" value="${diagnose.asvs }"></td>
				                                 <td><input type="text"  name="apvp" value="${diagnose.apvp }"></td>
				                                 <td><input type="text"  name="apvs" value="${diagnose.apvs }"></td>
				                               </tr>
				                               <tr>
				                                <td>pvc</td>
				                               </tr>
				                               <tr>
				                                <td><input type="text"  name="pvc" value="${diagnose.pvc }"></td>
				                               </tr>
				                                <tr>
				                                  <td>AMS事件</td>
				                                  <td>模式转换</td>
				                                ...
				                                <tr>
				                                <td><input type="text"  name="ams" value="${diagnose.ams }"></td>
				                                 <td><input type="text"  name="exchange" value="${diagnose.exchange }"></td>
				                                 <td><input type="text" name="ataf" value="${diagnose.ataf }"></td>
				                               </tr>
				                               <tr>
				                                <td>vsr</td>
				                               </tr>
				                               <tr>
				                                <td><input type="text" name="vsr" value="${diagnose.vsr }"></td>
				                               </tr>
				                            </tbody>
				                        </table>
				         </div>
                    ...
                    <div class="gray-bg" id="test_div" style="padding: 20px 0px;margin-bottom: 20px">
                      ...
                      <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <input type="text" class="form-control"  name="predict_life" value="${test.predict_life }">
                                </div>
                                <label class="col-sm-1 control-label">电池电压</label>
                                <div class="col-sm-1">
                                    <input type="text" class="form-control"  name="elect_press" value="${test.elect_press }">
                                </div>
                                <label class="col-sm-1 control-label">电池内阻</label>
                                <div class="col-sm-1">
                                    <input type="text" class="form-control"  name="elect_forbid" value="${test.elect_forbid }">
                                </div>
                                <label class="col-sm-1 control-label">充电时间</label>
                                <div class="col-sm-1">
                                    <input type="text" class="form-control"  name="elect_time" value="${test.elect_time }">
                                </div>
                                <label class="col-sm-1 control-label">自身心率</label>
                                <div class="col-sm-1">
                                    <input type="text" class="form-control"  name="self_rate" value="${test.self_rate }">
                                </div>
                                <label class="col-sm-1 control-label">磁铁频率</label>
                                <div class="col-sm-1">
                                    <input type="text" class="form-control"  name="magnet_rate" value="${test.magnet_rate }">
                                </div>
                           </div>
                       <div class="table-responsive m-t well" style="margin-left: 5%;border: none" >
				                        <table class="table invoice-table">
				                            ...
				                            <tbody>
				                               <tr>
				                                 <td>心房</td>
				                                 <td><input type="text"  name="hreat_test_yuzhi" value="${test.hreat_test_yuzhi }"></td>
				                                 <td><input type="text"  name="hreat_test_width" value="${test.hreat_test_width }"></td>
				                                 <td><input type="text"  name="hreat_test_feel" value="${test.hreat_test_feel }"></td>
				                                 <td>有&nbsp;<input type="checkbox" class="js-switch" name="hreat_test_isfar" <c:if test="${test.hreat_test_isfar==1 }">checked</c:if>/>&nbsp;否</td>
				                               	 <td><input type="text"  name="hreat_test_forbid" value="${test.hreat_test_forbid }"></td>
				                               </tr>
				                                <tr>
				                                 <td>右室</td>
				                                 <td><input type="text"  name="right_test_yuzhi" value="${test.right_test_yuzhi }"></td>
				                                 <td><input type="text"  name="right_test_width" value="${test.right_test_width }"></td>
				                                 <td><input type="text"  name="right_test_feel" value="${test.right_test_feel }"></td>
				                                 <td>有&nbsp;<input type="checkbox" class="js-switch" name="right_test_isfar" <c:if test="${test.right_test_isfar==1 }">checked</c:if>/>&nbsp;否</td>
				                               	 <td><input type="text" name="right_test_forbid" value="${test.right_test_forbid }"></td>
				                               	 <td><input type="text"  name="right_test_hign" value="${test.right_test_hign }"></td>
				                               </tr>
				                                <tr>
				                                 <td>左室</td>
				                                 <td><input type="text"  name="left_test_yuzhi" value="${test.left_test_yuzhi }"></td>
				                                 <td><input type="text"  name="left_test_width" value="${test.left_test_width }"></td>
				                                 <td><input type="text"  name="left_test_feel" value="${test.left_test_feel }"></td>
				                                 <td>有&nbsp;<input type="checkbox" class="js-switch" name="left_test_isfar" <c:if test="${test.left_test_isfar==1 }">checked</c:if>/>&nbsp;否</td>
				                               	 <td><input type="text"  name="left_test_forbid" value="${test.left_test_forbid }"></td>
				                               </tr>
				                            </tbody>
				                        </table>
				           </div>
                          ...
                          <h2>HIS测试</h2>
                           <div class="form-group">
                             <label class="col-sm-2 control-label">HBP接口位置</label>
                              <div class="col-sm-2">
                                  <input type="text" class="form-control" name="hbp_location" value="${test.hbp_location }">
                              </div>
                            </div>
                           ...
                           <div class="form-group">
                             <label class="col-sm-1 control-label">HBP</label>
                                  <input type="text" class="myinput" name="hbp1" value="${test.hbp1 }">bpm
                                  <input type="text" class="myinput" name="hbp2" value="${test.hbp2 }">  v
                                  <input type="text" class="myinput" name="hbp3" value="${test.hbp3 }">ms
                           </div>
                           <div class="form-group">
                             <label class="col-sm-1 control-label">HP%</label>
                              <div class="col-sm-2">
                                  <input type="text" class="form-control"  name="hp_percent" value="${test.hp_percent }">
                              </div>
                           </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                             ...
                             VLEF <input type="text" class="myinput"  name="lvef" value="${test.lvef }">
                             LVESV <input type="text"  class="myinput"   name="lvesv" value="${test.lvesv }">
                             LVEDD  <input type="text"  class="myinput"   name="lvedd" value="${test.lvedd }">
                           </div>
                           <div class="form-group">
                               <label class="col-sm-1 control-label"></label>
                             RVD1 <input type="text" class="myinput"  name="rvd1" value="${test.rvd1 }">
                             RVD2 <input type="text"  class="myinput"   name="rvd2" value="${test.rvd2 }">
                             RVD3  <input type="text"  class="myinput"   name="rvd3" value="${test.rvd3 }">
                             RVD area  <input type="text"  class="myinput"   name="rvd_area" value="${test.rvd_area }">
                           </div>
                           <div class="form-group">
                               <label class="col-sm-1 control-label"></label>
                             RVFAC <input type="text" class="myinput"  name="rvfac" value="${test.rvfac }">
                             TAPSE <input type="text"  class="myinput"   name="tapse" value="${test.tapse }">
                             RVS  <input type="text"  class="myinput"   name="rvs" value="${test.rvs }">
                             RVIVV  <input type="text"  class="myinput"   name="rvivv" value="${test.rvivv }">
                             RVIVA  <input type="text"  class="myinput"   name="rviva" value="${test.rviva }">
                             mid-RV strain  <input type="text"  class="myinput"   name="mid_rv" value="${test.mid_rv }">
                             mid-RV SR  <input type="text"  class="myinput"   name="mid_rvsr" value="${test.mid_rvsr }">
                           </div>
                       </div>
                    <!--  -->
                    ...
                    <div class="gray-bg"  style="padding: 20px 0px;margin-bottom: 20px">
                       ...
                       <div class="form-group">
                               <label class="col-sm-1 control-label">参数调整</label>
                                <div class="col-sm-8">
                                    <textarea class="form-control" name="ajust_remark" >${item.ajust_remark }</textarea>
                                </div>
                        </div>
                    </div>
                           ...
                           <!-- recode记录 -->
                             <c:forEach items="${records }" var="record">
	                           <div class="form-group record">
	                                 ...
	                                 <div class="col-sm-2">
	                                      <input type="text" class="form-control"  name="method" value="${record.method }">
	                                 </div>
	                                 <div class="col-sm-2">
	                                    <input type="text" class="form-control"  name="result" value="${record.result}">
	                                 </div>
	                                 <div class="col-sm-1">
	                                     <button class="btn btn-warning" type="button" onclick="$(this).parents('.record').remove()">删除</button>
	                                 </div>
	                            </div>
                            </c:forEach>
                        </div>
				                            ...
				                            <tbody>
				                               <c:forEach items="${drugs}" var="d">
				                                <tr>
				                                   ...
				                                   <td><input type="text"  name="num" value="${d.num }"></td>
				                                   <td><select class="form-control" name="unit"> 
				                                       <option value="1" <c:if test="${d.unit==1}">selected</c:if> >mg</option>
				                                        <option value="2" <c:if test="${d.unit==2}">selected</c:if>>g</option>
				                                        </select>
				                                    </td>
				                                     <td><select class="form-control" name="use_usage">
				                                         <option value="1" <c:if test="${d.use_usage==1}">selected</c:if>>口服</option> 
				                                         <option value="2" <c:if test="${d.use_usage==2}">selected</c:if>>日服</option>
				                                         </select>
				                                     </td>
				                                     <td> <select class="form-control" name="rate">
				                                          <option value="1" <c:if test="${d.rate==1}">selected</c:if>>每日一次</option>
				                                          <option value="2" <c:if test="${d.rate==2}">selected</c:if>>每日三次</option>
				                                          </select>
				                                     </td>
				                                     <td><input type="text"  name="start_date" value="<fmt:formatDate value='${d.start_date}' pattern="yyyy-MM-dd"/>" ></td>
				                                     <td><input type="text"  name="end_date" value="<fmt:formatDate value='${d.end_date}' pattern="yyyy-MM-dd"/>"></td>
				                                     <td><button class="btn btn-warning" type="button" onclick="$(this).parents('tr').remove()">删除</button><td>
				                                </tr>
				                                </c:forEach>
				                            </tbody>
				                        </table>
    ...
    <script>
        ...
        $('.chosen-select').chosen();
        $("[name='check_unit']").val("${item.check_unit}");
        $("[name='week_type']").val("${item.week_type}");
        ...
        function add(){
        	...
        	var brady={"item_id":"${brady.item_id}","work_mode":$("[name='work_mode']").val(),"basic_rate":$("[name='basic_rate']").val(),"up_rate":$("[name='up_rate']").val(),"rest_rate":$("[name='rest_rate']").val(),"late_rate":$("[name='late_rate']").val(),
        	...
        	var icd={"item_id":"${icd.item_id}","vt1_name":$("[name='vt1_name']").val(),"vt1_ison":vt1_ison,"vt1_rate":$("[name='vt1_rate']").val(),"vt1_period":$("[name='vt1_period']").val(),"vt1_identify":$("[name='vt1_identify']").val(),"vt1_scheme":$("[name='vt1_scheme']").val(),
        	...
        	var diagnose={"item_id":"${diagnose.item_id}","ap":$("[name='ap']").val(),"vp":$("[name='vp']").val(),"bp":$("[name='bp']").val(),"asvp":$("[name='asvp']").val(),"asvs":$("[name='asvs']").val(),"apvp":$("[name='apvp']").val(),"apvs":$("[name='apvs']").val(),
        	...
        	var test={"item_id":"${test.item_id}","predict_life":$("[name='predict_life']").val(),"elect_press":$("[name='elect_press']").val(),"elect_forbid":$("[name='elect_forbid']").val(),"elect_time":$("[name='elect_time']").val(),"self_rate":$("[name='self_rate']").val(),"magnet_rate":$("[name='magnet_rate']").val(),
        	...
        	var params={"id":"${item.id}","visit_date":$("[name='visit_date']").val(),"next_date":$("[name='next_date']").val(),
