                        ...
                        <form action="" method="post" class="form-horizontal">
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="name" required data-bv-notempty-message="名称不能为空">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
   ...
   <script src="${ctx}/statics/manage/js/plugins/chosen/chosen.jquery.js"></script>
    ...
    <script>
        ...
        function add(){
        	...
        	var pid="0";
        	if("${pid}"!=0) pid=$("[name='pid']").val();
        	$(".btn-primary").attr("disabled",true);
        	$.post("${ctx}/manage/hlabel/add",{"pid":pid,"name":$("[name='name']").val()},function(data){
        		if(data.code=="0"){
					opt_success("添加成功",0);
				}else if(data.code=="2"){
					opt_error("名称重复");
