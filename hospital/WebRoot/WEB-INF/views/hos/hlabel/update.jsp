...
<body>
                    ...
                    <div class="ibox-content">
                        <form action="" method="post" class="form-horizontal">
                          ...
                          <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select class="chosen-select" name="pid">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="name" value="${hlabel.name }" required data-bv-notempty-message="名称不能为空">
                                </div>
                            </div>
                            <div class="form-group">
    ...
    $(document).ready(function() {
        ...
        function update(){
        	...
        	var pid="0";
        	if("${hlabel.pid}"!="0") pid=$("[name='pid']").val();
        	 $(".btn-primary").attr("disabled",true);
        	$.post("${ctx}/manage/hlabel/update",{"id":"${hlabel.id}","pid":pid,"name":$("[name='name']").val()},function(data){
        		if(data.code=="0"){
					opt_success("修改成功",0);
				}else if(data.code=="2"){
					opt_error("名称重复");
