...
<body>
                    ...
                    <div class="ibox-content">
                        <form action="" method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="title" value="${news.title }" placeholder="标题">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="author" value="${news.author }" placeholder="作者">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" rows="3" name="descript" style="resize: none" placeholder="摘要">${news.descript }</textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="url" value="${news.url }" placeholder="链接">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
    ...
    <script>
        ...
        function add(){
        	$.post("${ctx}/manage/news/update",{"id":"${news.id}","type":$("[name='type']").val(),"title":$("[name='title']").val(),"image":$(".imageImg img").attr("src"),"author":$("[name='author']").val(),"descript":$("[name='descript']").val(),"url":$("[name='url']").val(),"content":ue.getContent()},function(data){
					if(data.code=="0"){
						opt_success("修改成功",0);
					}else{
