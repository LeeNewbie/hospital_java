...
<body>
                    ...
                    <div class="ibox-content">
                        <form action="" method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" rows="3" name="descript" style="resize: none" placeholder="摘要"></textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
    ...
    <script>
        ...
        function add(){
        	$.post("${ctx}/manage/news/add",{"type":$("[name='type']").val(),"title":$("[name='title']").val(),"image":$(".imageImg img").attr("src"),"author":$("[name='author']").val(),"descript":$("[name='descript']").val(),"url":$("[name='url']").val(),"content":ue.getContent()},function(data){
					if(data.code=="0"){
						opt_success("添加成功",0);
					}else{
