...
<body>
                    ...
                    <div class="ibox-content">
                        <form action="" method="post" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="name" placeholder="名称" value="${business.name }">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="imageImg" <c:if test="${empty business.image}"> style="display:none"</c:if> >   
							             <img src="${business.image }" style="width: 60px;height: 60px">
							         </div>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="radio radio-success radio-inline">
                                        <input type="radio" id="method2" value="1" name="method" <c:if test="${business.method==1 }">checked</c:if>>
                                        <label for="method2"> 打开H5链接 </label>
                                    </div>
                                    <div class="radio radio-success radio-inline">
                                        <input type="radio" id="method3" value="2" name="method" <c:if test="${business.method==2 }">checked</c:if>>
                            ...
                            <div class="form-group" id="directDiv">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="direct" placeholder="App定制功能，请咨询开发部门" value="${business.direct }">
                                </div>
                            </div>
                            <div class="form-group" id="urlDiv">
                                <label class="col-sm-2 control-label">链接</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="url" placeholder="链接" value="${business.url }">
                                </div>
                            </div>
                            ...
                            <shiro:hasPermission name="manage:advert:updateStart">
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
    ...
    <script>
        $(document).ready(function(){$(".i-checks").iCheck({checkboxClass:"icheckbox_square-green",radioClass:"iradio_square-green"});initRadio();});
        ...
        function update(){
        	$.post("${ctx}/manage/appset/update",{"id":"${business.id}","name":$("[name='name']").val(),"image":$(".imageImg img").attr("src"),"method":$("[name='method']:checked").val(),"direct":$("[name='direct']").val(),"url":$("[name='url']").val(),"content":ue.getContent()},function(data){
					if(data.code=="0"){
						layer.msg("修改成功", {
							icon : 1
						});
        ...
        function initRadio(){
        	var cur=$("[name='method']:checked").val();
        	if(cur=='0'){
        		$('#directDiv').show();
        		$('#urlDiv').hide();
        		$('#contentDiv').hide();
